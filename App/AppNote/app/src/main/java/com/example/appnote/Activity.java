...
public class Activity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        naview = findViewById(R.id.navDawar);
        naview.setItemIconTintList(null);

        emailuser=naview.getHeaderView(0).findViewById(R.id.emailUser);
        nameuser=naview.getHeaderView(0).findViewById(R.id.nameUser);
        userInfo();
